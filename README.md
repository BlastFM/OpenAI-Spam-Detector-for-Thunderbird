...
![Extension Version](https://img.shields.io/badge/version-1.4.5-blue.svg)
...
**v1.4.5 is the current stable release**, verified to automatically scan and correctly route new messages (including those arriving in the Junk folder) and to restore manual "Mark as Spam (Train AI)" / "Mark as Not Spam" actions on current Thunderbird MV3 builds. It also disables the "Export backup" button when there is no spam log or training memory to export.
...
Filename: openai-spam-detector-v1.4.5.xpi
### SHA-256: `C8B484D0E0B3B6CAFC8E5161212C025FBF2E927260CAED07DDDC5FEAEFEEEF6F`
...
[![Download Release](https://img.shields.io/badge/Download-v1.4.5_.XPI-blue?style=for-the-badge&logo=thunderbird&logoColor=white)](https://github.com/BlastFM/ThunderbirdPersonalSpamFilter/releases/download/v1.4.5/openai-spam-detector-v1.4.5.xpi)
...
| :--- | :--- | :--- |
| **Extension Binary** | Ready-to-install Thunderbird Add-on | [`openai-spam-detector-v1.4.5.xpi`](https://github.com/BlastFM/ThunderbirdPersonalSpamFilter/releases/download/v1.4.5/openai-spam-detector-v1.4.5.xpi) |
| **Source Code** | Compressed source files (`.zip`) | [`Source code (zip)`](https://github.com/BlastFM/ThunderbirdPersonalSpamFilter/archive/refs/tags/v1.4.5.zip) |
...
2. Click the extension download button above to save **`openai-spam-detector-v1.4.5.xpi`**.
...
├── README.md
├── openai-spam-detector-v1.4.5.xpi
├── icons/
│   ├── icon-48.png
│   ├── icon.png
